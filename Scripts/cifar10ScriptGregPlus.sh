...
python train_sea.py --id cifar10 --jacobianLoss 1 --batch_size 32 --seed 2 --beta 0.1 --oodMethod energy\
     --arch densenet101 --spt 0 --ept 10000 --singleLrStone 50 --epochs 60 --sampleTwoWay --num_cluster 32
